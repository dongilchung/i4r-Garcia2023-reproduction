...
% Alpha 
figure,
plot(orig_data_LE_alpha, orig_code_LE_alpha,'k.','markersize',15)
box off, set(gca,'LineWidth',2.0) 
[r,p] = corr(orig_data_LE_alpha, orig_code_LE_alpha,'type','pearson')

p<10^(-16)

% Beta
figure,
plot(orig_data_LE_beta, orig_code_LE_beta,'k.','markersize',15)
box off, set(gca,'LineWidth',2.0) 
[r,p] = corr(orig_data_LE_beta, orig_code_LE_beta,'type','pearson')
...
% Beta
figure,
plot(orig_data_ES_beta, orig_code_ES_beta,'k.','markersize',15)
box off, set(gca,'LineWidth',2.0) 
[r,p] = corr(orig_data_ES_beta, orig_code_ES_beta,'type','pearson')

p<10^(-16)

% Midpoints
figure,
plot(orig_data_ES_midpoints(:), orig_code_ES_midpoints(:),'k.','markersize',15)
box off, set(gca,'LineWidth',2.0) 
[r,p] = corr(orig_data_ES_midpoints(:), orig_code_ES_midpoints(:),'type','pearson')
...
for ii=1:8
    figure,
    plot(orig_data_ES_midpoints(:,ii), orig_code_ES_midpoints(:,ii),'k.','markersize',15)
    box off, set(gca,'LineWidth',2.0)
    [r,p] = corr(orig_data_ES_midpoints(:,ii), orig_code_ES_midpoints(:,ii),'type','pearson')
    Table1_1 = [Table1_1; r p];
end

%%% 3)EE
% Beta
figure,
plot(orig_data_EE_beta, orig_code_EE_beta,'k.','markersize',15)
box off, set(gca,'LineWidth',2.0) 
[r,p] = corr(orig_data_EE_beta, orig_code_EE_beta,'type','pearson')

p<10^(-16)

% Midpoints
figure,
plot(orig_data_EE_midpoints(:), orig_code_EE_midpoints(:),'k.','markersize',15)
box off, set(gca,'LineWidth',2.0) 
[r,p] = corr(orig_data_EE_midpoints(:), orig_code_EE_midpoints(:),'type','pearson')
...
for ii=1:8
    figure,
    plot(orig_data_EE_midpoints(:,ii), orig_code_EE_midpoints(:,ii),'k.','markersize',15)
    box off, set(gca,'LineWidth',2.0)
    [r,p] = corr(orig_data_EE_midpoints(:,ii), orig_code_EE_midpoints(:,ii),'type','pearson')
    Table1_2 = [Table1_2; r p];
end
