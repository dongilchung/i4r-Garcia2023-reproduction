...
for exp_num = selected_exp
    ...
    stanAccum_p2_sym   = [stanAccum_p2_sym; reshape(fit_params.p2',[size(fit_params.cho,1).*size(fit_params.cho,2),1])];
...
save('stan/Data/stanBehav_EE_choices.mat','stanAccum_*')