...
%% A8. Slope analysis between the inferred P(win) and the actual values: T-test comparison of slopes across Experiments 5-6 and task modalities (ES, EE)
...
for ii=1:length(label1)
    ...
    %%% corrected-p
    tmp_corrected_pval = p.*3;

    tmp_P_adjusted = {'Bonf'};
    tmp_alternative = {'two-sided'};
    tmp_Paired = {'False'};
    tmp_Parametric = {'True'};
    stat_A8_1 = [stat_A8_1; ii {'exp_num'} label1(ii) label2(ii) tmp_Paired tmp_Parametric tmp_tval tmp_dof tmp_alternative tmp_uncorrected_pval tmp_corrected_pval tmp_P_adjusted tmp_BF10 tmp_cohen_d];
end
...
for ii=1:length(label1)
    ...
    tmp_Paired = {'True'};
    tmp_Parametric = {'True'};
    stat_A8_1 = [stat_A8_1; ii {'modality'} label1(ii) label2(ii) tmp_Paired tmp_Parametric tmp_tval tmp_dof tmp_alternative tmp_uncorrected_pval tmp_corrected_pval tmp_P_adjusted tmp_BF10 tmp_cohen_d];
end
...
for exp_num = selected_exp
    ...
    for ii=1:length(label1)
        ...
        tmp_Parametric = {'True'};
        tmp_P_adjusted = {'Bonf'};
        stat_A8_1 = [stat_A8_1; tmp_exp_num {'exp_num * modality'} ...
...
for exp_num = selected_exp
    ...
    p_dd1  = y(x==exp_num&z==1);
    p_dd2  = y(x==exp_num&z==0);
    ss1  = raw_subject(x==label1(ii));
    ss2  = raw_subject(x==label2(ii));
    ...
    tmp_Paired = {'True'};
    tmp_Parametric = {'True'};
    stat_A8_2 = [stat_A8_2; {'T-test'} tmp_tval tmp_dof tmp_alternative tmp_uncorrected_pval tmp_CI98 tmp_cohen_d tmp_BF10 tmp_power];
end
